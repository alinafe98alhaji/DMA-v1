...
const Question1aiii = () => {
  ...
  // Parse areas from the query string once router is ready
  useEffect(
    () => {
      if (router.isReady) {
        const query = router.query;

        setAreasFor1aiii(JSON.parse((query.areasFor1aiii as string) || "[]"));
        setAreasFor1av(JSON.parse((query.areasFor1av as string) || "[]"));
      }
    },
