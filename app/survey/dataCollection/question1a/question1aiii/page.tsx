...
const Question1aiii = () => {
  ...
  // Extract areas from query params (client-side parsing)
  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    setAreasFor1aiii(JSON.parse(params.get("areasFor1aiii") || "[]"));
    setAreasFor1av(JSON.parse(params.get("areasFor1av") || "[]"));
  }, []);
