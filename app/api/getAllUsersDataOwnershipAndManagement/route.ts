...
//       // Fetch the responses for the current user from the "data ownership and management" collection
//       const responses = await db
//         .collection("data ownership and management") // Adjust collection name as needed
//         .find(
//           { "responses.score": { $exists: true }, userId: userId },
...
//       // Adjust the calculation as needed based on the collection (e.g., divide by 13)
//       const summedScores = Object.keys(aggregatedScores).map(area => ({
//         area,
//         totalScore: aggregatedScores[area].totalScore / 13 * 100, // Adjust as necessary
